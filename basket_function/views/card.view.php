    ...
    <div class="container">
        ...
        <?php if(count($cardItems) > 0): ?>
            <form action="card.php" method="post">
                    ...
                    <tbody>
                        <?php foreach($cardItems as $item): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="card.php?action=remove&product_remove=<?= $item->id ?>">Remove</a>
                                </td>
                            </tr>
                        <?php endforeach ?>
                    </tbody>
                ...
                <a href="card.php?action=remove_all" class="btn btn-secondary">Clean the basket</a>
                <input type="submit" class="btn btn-danger" name="btn" value="Save Changes">
            </form>
        <?php else: ?>
